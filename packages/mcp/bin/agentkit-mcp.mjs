 ...
 * to serve every agent rather than one desktop. This is the piece in between.
 *
 ...
 *   AGENTKIT_API_KEY=ak_live_... agentkit-mcp https://sharmakirana.in/agent/mcp
 */
...
if (apiKey === undefined) log("no AGENTKIT_API_KEY set, connecting anonymously");
...
async function forward(message) {
  const response = await fetch(endpoint, {
    ...
    headers: {
      ...
      ...(apiKey === undefined ? {} : { "x-agentkit-key": apiKey }),

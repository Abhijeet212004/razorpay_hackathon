...
const Shipping = () => {
    ...
    // Empty string, never undefined: an undefined value makes a MUI Select uncontrolled,
    // and an uncontrolled Select never enforces `required` — which is how an order could
    // be placed with no state at all.

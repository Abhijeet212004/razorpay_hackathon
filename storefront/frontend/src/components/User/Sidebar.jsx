        ...
        <div className="hidden sm:flex flex-col gap-4 w-1/4 px-1">
            ...
            <div className="flex flex-col bg-white rounded-sm shadow">
                ...
                <div className="flex flex-col pb-3 border-b text-sm">
                    ...
                    <Link to="/account/addresses" className={`${activeTab === "addresses" ? "bg-blue-50 text-primary-blue font-medium" : "hover:bg-blue-50 hover:text-primary-blue"} p-3 pl-14`}>Manage Addresses</Link>
